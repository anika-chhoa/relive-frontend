...
export default function GoogleButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex w-full items-center justify-center gap-3 rounded-field border border-border bg-surface px-4 py-2.5 text-sm font-medium text-ink transition-standard hover:bg-cta-tint/40 hover:shadow-soft"
    >
